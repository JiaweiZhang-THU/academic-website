    ...
    content:
      ...
      items:
        - name: Reviewer for Journal
          description: [IEEE Transactions on Intelligent Transportation Systems](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=6979); [IEEE Transactions on Intelligent Vehicles](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=7274857); IEEE Antennas and Wireless Propagation Letters; 自动化学报]
          icon: newspaper
          icon_pack: fas
